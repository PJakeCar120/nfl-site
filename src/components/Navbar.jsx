    ...
    <header className="w-full px-6 py-4 shadow-md bg-blue-50 sticky top-0 z-50">
      <div className="w-full">
        <div className="flex flex-col sm:flex-row sm:items-center sm:gap-x-6 gap-y-4">
          ...
          {/* Scrollable nav bar on mobile */}
          <nav className="flex flex-nowrap overflow-x-auto whitespace-nowrap text-blue-800 text-xs sm:text-sm font-medium gap-4 no-scrollbar">
