...
const projects = {
  ...
  qb2024: {
    ...
    description: "QB model results: all stats in percentiles except Analytical Score (min 250 dropbacks). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  rb2024: {
    ...
    description: "RB model results: all stats in percentiles except Analytical Score (min 50 rushes). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  wr2024: {
    ...
    description: "WR model results: all stats in percentiles except Analytical Score (min 30 targets). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  te2024: {
    ...
    description: "TE model results: all stats in percentiles except Analytical Score (min 200 routes). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  idl2024: {
    ...
    description: "IDL model results: all stats in percentiles except Analytical Score (min 150 pass rush, run stop snaps). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  edge2024: {
    ...
    description: "EDGE model results: all stats in percentiles except Analytical Score (min 100 pass rush, run stop snaps). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  ilb2024: {
    ...
    description: "ILB model results: all stats in percentiles except Analytical Score (min 100 coverage, run stop snaps). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  cb2024: {
    ...
    description: "CB model results: all stats in percentiles except Analytical Score (min 200 coverage snaps). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
  ...
  s2024: {
    ...
    description: "S model results: all stats in percentiles except Analytical Score (min 250 snaps). The Analytical Score uses my custom formula, weighting the most important stats more heavily. It is meant to serve as an overall season grade.",
            ...
            <tr>
              {headers.map((key) => (
                <th
                  ...
                  className="border px-2 py-1 text-left break-normal font-mono text-[10px] sm:text-sm max-w-[80px] cursor-pointer hover:bg-gray-200"
              ...
              <tr key={i} className="odd:bg-white even:bg-gray-50">
                {headers.map((key, j) => {
                  ...
                  return (
                    <td
                      key={j}
                      className="border px-2 py-1 text-[10px] sm:text-sm text-gray-800 break-normal font-mono max-w-[80px]"
